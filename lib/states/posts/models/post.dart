...
class Post {
  ...
  final String thumbnailStoreageId;
  final String orginalFileStorageId;
  Post({
    ...
    required Map<String, dynamic> json,
        ...
        thumbnailStoreageId = json[PostKey.thumbnailStoreageId],
        orginalFileStorageId = json[PostKey.orginalFileStorageId],
        postSettings = {
